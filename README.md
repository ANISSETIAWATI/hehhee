...
* **Video Pitching:** [https://youtube.com/watch?v=la1l5-pr0Mc](https://youtube.com/watch?v=la1l5-pr0Mc)
* **Deployment Frontend:** [Link Netlify Anda]
* **Deployment Backend:** [Link Vercel Anda]

---

## 📌 Catatan

* Sistem rekomendasi menggunakan logika berbasis database (tanpa AutoML).
* Repository GitHub bersifat **private** dan hanya diakses oleh pihak terkait.
